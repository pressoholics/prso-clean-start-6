...
/**
 * Register: prso/intro-block Gutenberg Block.
 *
 * Block to create a intro-block. Users create a WP gallery using media modal.
 *
 ...
 */
registerBlockType('prso/intro-block', {
    // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
    title: __('Introduction'), // Block title.
    icon: 'editor-alignleft', // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
