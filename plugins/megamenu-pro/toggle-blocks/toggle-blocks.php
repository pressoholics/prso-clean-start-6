            ...
            foreach( $toggle_blocks as $index => $settings ) {
                ...
                if ( isset( $settings['type'] ) && $settings['type'] == 'logo' ) {
                    ...
                    $styles = array(
                        ...
                        'logo_max_height' => isset($settings['max_height']) ? $settings['max_height'] : "40px",
                    );
            ...
            foreach( $toggle_blocks as $index => $settings ) {
                ...
                if ( isset( $settings['type'] ) && $settings['type'] == 'search' ) {
                    ...
                    $styles = array(
                        ...
                        'search_vertical_offset' => isset($settings['vertical_offset']) ? $settings['vertical_offset'] : $defaults['vertical_offset'],
                        'search_width' => isset($settings['width']) ? $settings['width'] : $defaults['width']
                    );
