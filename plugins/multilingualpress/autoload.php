...
const AUTOLOAD_MAP = [
    ...
    Framework\Admin\Pointers::class => '/src/framework/Admin/Pointers.php',
    Framework\Admin\PointersRepository::class => '/src/framework/Admin/PointersRepository.php',
    ...
    Activation\Onboarding\Messages::class => '/src/multilingualpress/Activation/Onboarding/Messages.php',
    Activation\Onboarding\Onboarding::class => '/src/multilingualpress/Activation/Onboarding/Onboarding.php',
    Activation\Onboarding\State::class => '/src/multilingualpress/Activation/Onboarding/State.php',
    ...
    Core\Admin\LanguageManager\Db::class => '/src/multilingualpress/Core/Admin/LanguageManager/Db.php',
    Core\Admin\LanguageManager\LanguageInstaller::class => '/src/multilingualpress/Core/Admin/LanguageManager/LanguageInstaller.php',
    Core\Admin\LanguageManager\PageView::class => '/src/multilingualpress/Core/Admin/LanguageManager/PageView.php',
    Core\Admin\LanguageManager\RequestHandler::class => '/src/multilingualpress/Core/Admin/LanguageManager/RequestHandler.php',
    Core\Admin\LanguageManager\TableFormView::class => '/src/multilingualpress/Core/Admin/LanguageManager/TableFormView.php',
    Core\Admin\LanguageManager\Updater::class => '/src/multilingualpress/Core/Admin/LanguageManager/Updater.php',
    ...
    Translator\FrontPageTranslator::class => '/src/multilingualpress/Translator/FrontPageTranslator.php',
