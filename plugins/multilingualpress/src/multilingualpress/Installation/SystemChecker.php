...
class SystemChecker
{
    ...
    public function checkInstallation(): int
    {
        ...
        $deactivator->deactivatePluginAndDie();
    ...
    /**
     * Checks if the current PHP version is the required version higher, and
     * collects potential error messages.
     */
    private function checkPhpVersion()
    {
        $current = (string)new SemanticVersionNumber(PHP_VERSION);
        $required = (string)new SemanticVersionNumber(self::MINIMUM_PHP_VERSION);
        ...
        $this->wpError->add('', sprintf($message, $required, $current));
    }
    ...
    private function checkWordpressVersion()
    {
        ...
        $this->wpError->add('', sprintf($message, (string)$required, (string)$current));
    }
